...
The cursor respects the operating system's reduced-motion preference. A future pause-and-takeover mode can pause the agent while the user interacts directly with the visible Chrome window; it is listed in `ENHANCEMENTS.md`.
